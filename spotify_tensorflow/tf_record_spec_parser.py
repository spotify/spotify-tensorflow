...
FeatureInfo = namedtuple("FeatureInfo", ["name", "type", "tags"])
...
class TfRecordSpecParser(object):
    ...
    def parse_tf_record_spec(cls, tf_record_desc_path, dir_path):
        ...
        type_map = {
            ...
            "Int64List": tf.int64,
            "BytesList": tf.int8  # FIXME: not sure
        }
        feature_info = [FeatureInfo(name, type_map[t], tags) for name, t, tags in spec["features"]]
