...
class DummyPreprocess(TFTransform):
    def get_preprocessing_fn(self):
        ...
        def preprocessing_fn(inputs):
            out = dict()
            out["test_feature_tx"] = tft.scale_to_z_score(inputs["test_feature"])
            return out
...
class TFTransformTest(TestCase):
    ...
    def test_task(self):
        ...
        transformed_train = [js["features"]["feature"]["test_feature_tx"]["floatList"]["value"]
        ...
        transformed_eval = [js["features"]["feature"]["test_feature_tx"]["floatList"]["value"]
                            for js in parse_tf_records(path)]
